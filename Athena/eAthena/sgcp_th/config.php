<?php
// Database Settings
$CONFIG['sql_host']			=	'sql206.ispace.in.th';			// ไม่ต้องทำอะไร โดยปกติจะเป็น localhost
$CONFIG['sql_username']		=	'ispac_3441926';			// ระบุ User ของ SQL
$CONFIG['sql_password']		=	'altzef';			// ระบุ Password ของ SQL
$CONFIG['sql_dbname']		=	'ispace_3441926_1';			// ระบุชื่อฐานข้อมูลของ Ragnarok
$CONFIG['sql_cpdbname']		=	'ispace_3441926_2';			// ชื่อของฐานข้อมูล CP
$CONFIG['mysql_charset']		=	'auto';			// ตั้งค่า Charset ของ Mysql (auto, disable, tis620, UTF8 and etc.)
$CONFIG['server_name']		=	'All-RO Server';		// ระบุชื่อเซิร์ฟเวอร์
$CONFIG['language']		=	'Thai';			// ระบุภาษาของ CP (Thai, English)
...
$CONFIG['admin_email']		=	'all-ro@hotmail.com';	// ระบุ E-Mail Address
...
// SMTP Settings
$CONFIG['smtp_host']		=	'sql206.ispace.in.th';			// SMTP Host (ค่าปกติ: localhost)
...
$CONFIG['check_server']		=	'1';			// ระบุโหมดของการตรวจสอบสถานะของเซิร์ฟเวอร์ (0: ปิดบังสถานะ 1:เพื่อให้ตรวจสอบสถานะ)
...
$CONFIG['server_ip']			=	'all-ro.no-ip.info';			// ระบุ IP Address ของเครื่องคุณที่ใช้ในการตรวจสอบสถานะเซิร์ฟเวอร์
...
// Forum Settings
$CONFIG['forum_name']		=	'All-RO Community';	// ระบุชื่อฟอรั่ม
